...
RegisterCommand("10-38", function()
	ESX.TriggerServerCallback('pdt_10-38:checkjob', function(ils1)
		if ils1 == true then
				local Officer = {}
				...
				TriggerServerEvent("pdt_10-38:request", Officer)
		else
...
RegisterNetEvent("pdt_10-38:alert")
AddEventHandler("pdt_10-38:alert", function(source, Officer)
